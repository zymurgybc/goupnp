...
func (client *ContentDirectory1) ImportResource(SourceURI string, DestinationURI string) (TransferID uint32, err error) {
	...
	if request.SourceURI, err = soap.MarshalString(SourceURI); err != nil {
		return
	}
	if request.DestinationURI, err = soap.MarshalString(DestinationURI); err != nil {
		return
	}
	// END Marshal arguments into request.
...
func (client *ContentDirectory1) DeleteResource(ResourceURI string) (err error) {
	...
	if request.ResourceURI, err = soap.MarshalString(ResourceURI); err != nil {
		return
	}
	// END Marshal arguments into request.
